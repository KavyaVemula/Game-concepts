...
for i in range(15):
    ...
    y = 30
    segment = Segment(x, y)
    # Creates the Head for the Snake
    if(i == 0):
...
while not done:
    ...
    # Inserts the new segment as the head of the snake
    ...
    # Checking if the snake head collides with its tail
    head_hit_list = pygame.sprite.spritecollide(head, segment_group, False)
         
    if(len(head_hit_list) > 0):
        print("Game over!!")
        
    # if (head.rect.x > 800 or
    #        head.rect.y > 600):
    #    print("Collides with the wall!! Game Over!!")
